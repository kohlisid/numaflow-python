...
class TestAccumulatorUseCases(unittest.TestCase):
    ...
    async def test_stream_sorter_functionality(self):
    ...
    async def test_stream_joiner_functionality(self):
    ...
    def test_run_async_tests(self):
        ...
        asyncio.run(self.test_stream_sorter_functionality())
        asyncio.run(self.test_stream_joiner_functionality())
